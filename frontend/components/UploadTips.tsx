export function UploadTips() {
  return (
    <aside className="w-full rounded-2xl border border-gray-100 bg-white/90 p-4 shadow-card sm:p-6 lg:sticky lg:top-16 lg:max-w-sm">
      <h3 className="text-base font-semibold text-gray-900 sm:text-lg">Upload tips</h3>
      <ul className="mt-3 space-y-2 text-xs text-gray-600 sm:mt-4 sm:space-y-3 sm:text-sm">
      ...
      <div className="mt-4 flex items-center gap-2 rounded-xl bg-primary-light px-3 py-2 text-xs text-primary sm:mt-6 sm:gap-3 sm:px-4 sm:py-3 sm:text-sm">
